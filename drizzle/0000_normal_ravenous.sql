...
CREATE TABLE "dreams" (
	...
	"image_status" "generation_status" DEFAULT 'generating' NOT NULL,
	"image_data" "bytea",
...
CREATE INDEX "dreams_user_created_idx" ON "dreams" USING btree ("user_id","created_at");--> statement-breakpoint
